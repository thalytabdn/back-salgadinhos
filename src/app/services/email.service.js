...
const transporter = nodemailer.createTransport({
  ...
  auth: {
    type: 'Login',
    user: 'salgadinhos2finos@gmail.com',
    pass: 'salgadinhos1234'
  },
});
            ...
            <div>
                <div style='width: 50%; margin: 0 25% 0 25%; background-color: white; padding: 50px; border-radius: 30px;'>
                    ...
                    <div style="display: flex; justify-content: center; width: 100%; text-aling: center;">
                            <a href="${process.env.BASE_URL_RECOVERY_PASSWORD}/recoverPassword/${token}" style="display: flex; cursor: pointer; justify-content: center; margin-top: 50px; text-decoration: none; width: 100%; "> 
